	...
	<div class="layui-container">
		<div class="layui-row layui-col-space20">
			<div class="layui-col-md8">
				...
				<a class="prev" href="/ssm/cate?current=1&category=${category}">&lt;&lt;</a> &nbsp&nbsp
				<a style="<%=display1%>" class="num" href="/ssm/cate?current=<%=current-1%>&category=${category}"><%=current-1%></a> &nbsp&nbsp
			    <span class="current" style="background-color:#009688"><%=current%></span> &nbsp&nbsp
			    <a style="<%=display2%>" class="num" href="/ssm/cate?current=<%=current+1%>&category=${category}"><%=current+1%></a> &nbsp&nbsp
