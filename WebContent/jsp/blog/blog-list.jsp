...
<body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a>SSM架构</a> <a>文章管理</a>
	...
	<div class="x-body">
		...
		<button class="layui-btn"
			onclick="x_admin_show('添加文章','jsp/blog/blog-add.jsp')">
			<i class="layui-icon"></i>添加
		</button>
		<span class="x-right" style="line-height: 40px">（每页10条数据）</span> <span
			class="x-right" style="line-height: 40px">共有数据：${count}条 </span> </xblock>
		...
		<div class="page">
			<div style="display:inline">
				<a class="prev" href="blog-list?pagenum=1">&lt;&lt;</a>&nbsp&nbsp
				<div style="display:inline;${display};"><a class="num" href="blog-list?pagenum=${prev}">${prev}</a>&nbsp&nbsp</div>
				<span class="current" style="background-color: #009688">${pagenum}</span>&nbsp&nbsp
				<div style="display:inline;${display2};"><a class="num" href="blog-list?pagenum=${next}">${next}</a>&nbsp&nbsp</div>
				<a class="next" href="blog-list?pagenum=${last}">&gt;&gt;</a>
			</div>
		</div>
